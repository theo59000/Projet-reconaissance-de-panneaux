...
def load_label_map(path):
    ...
    return label_map
# Charger le modèle
model = tf.keras.models.load_model("Detection_panneaux-11/my_model.keras")  # Ajuste le chemin si besoin
label_map = load_label_map('Detection_panneaux-11/test/objects_label_map.pbtxt')
